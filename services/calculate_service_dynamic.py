...
def calculate_topsis(
    ...
    results = []
    for alternative, preference_value, positive_distance, negative_distance in zip(
        data,
        preference_values,
        positive_distances,
        negative_distances,
        ...
        results.append({
            ...
            "kriteria": _build_original_values(alternative, criteria),
        })
...
def _build_criteria_values(
    ...
    return [
        _field_to_float(_get_value(alternative, criterion.name), criterion.name)
...
def _build_original_values(
    ...
    return {
        criterion.name: _get_value(alternative, criterion.name)
        for criterion in criteria
    }
